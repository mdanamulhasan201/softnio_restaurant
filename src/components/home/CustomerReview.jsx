            ...
            <div className="relative p-5 overflow-hidden">
                ...
                >
                    {originalData.map((item, index) => (
                        <div
                            key={index}
                            className="bg-[#FEBF00] flex flex-col items-center min-w-full "
                        >
                            <div className="flex flex-col md:flex-row justify-between">
                                <div className="md:w-1/2 w-full p-4 md:p-20 flex flex-col justify-between h-full order-2 md:order-1">
